...
The call returns a single `Registration` that unregisters all six
interceptors at once — hold onto it if you need to remove the logger
later, or ignore the return value for process-lifetime loggers.
...
- [Performance](/arch/performance/) — benchmark results across SwitchBoard, interceptors, and Compose
